package com.github.leifoolsen.jerseyguice.config;

import com.github.leifoolsen.jerseyguice.util.FileUtil;
import com.github.leifoolsen.jerseyguice.util.GsonTypeAdapters;
import com.github.leifoolsen.jerseyguice.util.SneakyThrow;
import com.github.leifoolsen.jerseyguice.util.StringUtil;
import com.github.leifoolsen.jerseyguice.util.ValidatorHelper;
    ...
    public static String load() {
        ...
        if(config == null) {
            ...
            if (StringUtil.blankToNull(resourceBaseName) == null) {
                logMessage = "Loading default config, application.conf. No fallback defined";
